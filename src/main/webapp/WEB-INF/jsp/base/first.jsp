...
<BODY style="overflow-y: hidden;" class="easyui-layout" scroll="no" >
	<DIV
		style='background: url("images/layout-browser-hd-bg.gif") repeat-x center 50% rgb(127, 153, 190); height: 50px; color: rgb(255, 255, 255); line-height: 20px; overflow: hidden; font-family: Verdana, 微软雅黑, 黑体;'
		...
		<SPAN style="padding-right: 20px; float: right;" class="head">
			...
			智睿HRP医院运营管理信息平台 </SPAN> <SPAN style="padding-left: 15px;" id="News"></SPAN>
	</DIV>
	...
	<DIV style="width: 180px;" id="west" title=" 供应商管理平台" split="true"
